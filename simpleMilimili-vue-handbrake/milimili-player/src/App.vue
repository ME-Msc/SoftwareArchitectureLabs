...
export default {
  ...
  methods: {
    ...
    getFiles: function() {
      this.$http.get("http://localhost:8083/files").then(function(res) {
        this.files = res.body;
        console.log(this.files);
      });
    },
    changeto360(name) {
      var nameTerm = name.split(".")[0];
      this.videoURL = "http://localhost:8083/play/360/" + nameTerm + "-360.mp4";
    ...
    changeto720(name) {
      var nameTerm = name.split(".")[0];
      this.videoURL = "http://localhost:8083/play/720/" + nameTerm + "-720.mp4";
      console.log(this.videoURL);
      this.$nextTick(() => {
        this.$refs.videoPlay.load();
      });
    ...
    changeto1080(name) {
      var nameTerm = name.split(".")[0];
      this.videoURL =
        "http://localhost:8083/play/1080/" + nameTerm + "-1080.mp4";
      console.log(this.videoURL);
      this.$nextTick(() => {
        this.$refs.videoPlay.load();
      });
